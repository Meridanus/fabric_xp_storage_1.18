...
public class ModItems {
    ...
    public static void registerItems() {
        //Items
        Registry.register(Registries.ITEM, new Identifier(XpStorage.MOD_ID, "xp_rod"), XP_ROD);
        Registry.register(Registries.ITEM, new Identifier(XpStorage.MOD_ID, "soul_copper_blend"), SOUL_COPPER_BLEND);
        Registry.register(Registries.ITEM, new Identifier(XpStorage.MOD_ID, "soul_copper_ingot"), SOUL_COPPER_INGOT);
        Registry.register(Registries.ITEM, new Identifier(XpStorage.MOD_ID, "soul_copper_nugget"), SOUL_COPPER_NUGGET);
        Registry.register(Registries.ITEM, new Identifier(XpStorage.MOD_ID, "xp_remover"), XP_REMOVER);
        Registry.register(Registries.ITEM, new Identifier(XpStorage.MOD_ID, "inspector"), INSPECTOR);
        Registry.register(Registries.ITEM, new Identifier(XpStorage.MOD_ID, "lock"), LOCK);
        Registry.register(Registries.ITEM, new Identifier(XpStorage.MOD_ID, "xp_dust"), XP_DUST);
        Registry.register(Registries.ITEM, new Identifier(XpStorage.MOD_ID, "key"), KEY);
        Registry.register(Registries.ITEM, new Identifier(XpStorage.MOD_ID, "handbook"), HANDBOOK);

        Registry.register(Registries.ITEM, new Identifier(XpStorage.MOD_ID,"xp_berries"), XP_BERRIES);
        Registry.register(Registries.ITEM, new Identifier(XpStorage.MOD_ID,"xp_berries_seeds"), XP_BERRIES_SEEDS);
        //BlockItems
        Registry.register(Registries.ITEM, new Identifier(XpStorage.MOD_ID, "block_xp_obelisk"), BLOCK_XP_OBELISK);
        Registry.register(Registries.ITEM, new Identifier(XpStorage.MOD_ID, "block_soul_copper"), BLOCK_SOUL_COPPER);
